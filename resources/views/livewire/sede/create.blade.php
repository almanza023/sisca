    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(135, 228, 123)">
                <h5 class="modal-title" id="exampleModalform">DATOS DE SEDE</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="field-2" class="control-label">Dirección</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="field-2" class="control-label">DANE</label>
                            <input type="text" wire:model="dane" class="form-control" >
                        </div>
                    </div>
                </div>
